...
public partial class AluraTunesContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ArtistaId).HasName("PK_Artist");
        ...
        modelBuilder.Entity<Cliente>(entity =>
        {
            ...
            entity.HasOne(d => d.Suporte).WithMany(p => p.Clientes)
        ...
        modelBuilder.Entity<Faixa>(entity =>
        {
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.Faixas)
                .HasForeignKey(d => d.AlbumId)
                .HasConstraintName("FK_FaixaAlbumId");

            entity.HasOne(d => d.Genero).WithMany(p => p.Faixas)
                .HasForeignKey(d => d.GeneroId)
                .HasConstraintName("FK_FaixaGeneroId");

            entity.HasOne(d => d.TipoMidia).WithMany(p => p.Faixas)
        ...
        modelBuilder.Entity<Funcionario>(entity =>
        {
            ...
            entity.HasOne(d => d.SeReportaANavigation).WithMany(p => p.InverseSeReportaANavigation)
        ...
        modelBuilder.Entity<ItemNotaFiscal>(entity =>
        {
            ...
            entity.HasOne(d => d.Faixa).WithMany(p => p.ItemNotaFiscals)
                .HasForeignKey(d => d.FaixaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ItemNotaFiscalFaixaId");

            entity.HasOne(d => d.NotaFiscal).WithMany(p => p.ItemNotaFiscals)
        ...
        modelBuilder.Entity<NotaFiscal>(entity =>
        {
            ...
            entity.HasOne(d => d.Cliente).WithMany(p => p.NotaFiscals)
        ...
        modelBuilder.Entity<Playlist>(entity =>
        {
            ...
            entity.HasMany(d => d.Faixas).WithMany(p => p.Playlists)
                .UsingEntity<Dictionary<string, object>>(
                    "PlaylistFaixa",
                    r => r.HasOne<Faixa>().WithMany()
